...
async function generateFromChunk(
  ...
  try {
    ...
    if (retries > 0) return generateFromChunk(chunk, studySetId, n, aiConfig, customPrompt, focusLessonContent, questionTypes, retries - 1)
...
export async function generateQuestions(
  ...
  return generateFromChunk(cappedText, studySetId, questionCount, aiConfig, customPrompt, focusLessonContent, questionTypes)
}
